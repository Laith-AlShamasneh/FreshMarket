        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumOrderAmount = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "decimal(6,3)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    DefaultImageUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SignInLogId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignInLogs", x => x.SignInLogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountTotal = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    ShippingTotal = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    TaxTotal = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    GrandTotal = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    ...
                    ShippingCarrier = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ShippingTrackingNumber = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxAmount = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    LineTotal = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
